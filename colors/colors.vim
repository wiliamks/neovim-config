...
hi xmlTag          ctermfg=2
hi xmlString       ctermfg=5
hi xmlAttrib       ctermfg=7
hi! link xmlEndTag xmlTag
hi xmlEqual        ctermfg=2
...
" Dart {{{
hi! dartLibrary guifg=2 gui=bold
hi! dartLibrary ctermfg=2 cterm=bold
hi! dartMetadata guifg=4 gui=bold
hi! dartMetadata ctermfg=4 cterm=bold
hi! dartInterpolation guifg=6
hi! dartInterpolation ctermfg=6
hi! dartType guifg=5 gui=bold
hi! dartType ctermfg=5 cterm=bold
" }}}
